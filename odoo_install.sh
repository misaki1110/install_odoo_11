...
sudo pip3 install pysftp==0.2.9 pyOpenSSL==19.0.0 openpyxl==2.5.7 phonenumbers xmlsig==0.1.3 jsonschema==3.0.* netifaces mechanicalsoup pypdf2==1.26.0 Babel==2.3.4 passlib==1.6.5 Werkzeug==0.11.15 decorator==4.0.10 python-dateutil==2.5.3 pyyaml==3.13 qrcode==5.3 pysftp==0.2.9 psycopg2==2.7.3.1 psutil==4.3.1 html2text==2016.9.19 docutils==0.12 lxml==4.2.3 pillow==4.0.0 reportlab==3.3.0 ninja2 requests==2.20.0 gdata XlsxWriter==0.9.3 vobject==0.9.3 python-openid pyparsing==2.1.10 pydot==1.2.3 mock==2.0.0 mako==1.0.4 Jinja2==2.10.1 ebaysdk==2.1.5 feedparser==5.2.1 xlwt==1.3.* psycogreen suds-jurko==0.6 pytz==2016.7 pyusb==1.0.0 greenlet==0.4.10 xlrd==1.0.0
