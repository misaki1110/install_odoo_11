...
sudo pip3 install pypdf2 Babel passlib Werkzeug decorator python-dateutil pyyaml==3.13 qrcode pysftp==0.2.9 psycopg2 psutil html2text docutils lxml pillow reportlab ninja2 requests gdata XlsxWriter vobject python-openid pyparsing pydot mock mako Jinja2 ebaysdk feedparser xlwt psycogreen suds-jurko pytz pyusb greenlet xlrd 
